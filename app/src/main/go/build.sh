...
go build -a -o ../jniLibs/armeabi-v7a/libgost-plugin.so github.com/ginuerzh/gost/cmd/gost

CC=$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang \
GOOS="android" GOARCH="arm64" CGO_ENABLED="1" \
go build -a -o ../jniLibs/arm64-v8a/libgost-plugin.so github.com/ginuerzh/gost/cmd/gost
...
go build -a -o ../jniLibs/x86/libgost-plugin.so github.com/ginuerzh/gost/cmd/gost
...
go build -a -o ../jniLibs/x86_64/libgost-plugin.so github.com/ginuerzh/gost/cmd/gost